...
def handler(q=False):
    ...
    try:
        ...
        elif attribute_type == 'url': result = client.search(attribute_value)   # TODO result = client.find_url(attribute_value)
        elif attribute_type == 'text': result = client.search(attribute_value)
        elif attribute_type == 'target-org': result = client.search(attribute_value, exact=True)
        elif attribute_type == 'btc': result = client.search(attribute_value)   # TODO
        elif attribute_type == 'phone-number': result = client.search(attribute_value)  # TODO
